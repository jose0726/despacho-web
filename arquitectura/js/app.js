document.addEventListener('DOMContentLoaded', () => {
  ...
  const duracionMinima = parseInt(document.body.dataset.preloaderTime, 10) || 500;
  ...
  if (document.readyState === 'complete') {
    ...
    window.addEventListener('load', onLoadHandler, { passive: true });
    // fallback robusto
    setTimeout(() => { runLogoSequence(); }, Math.max(10000, duracionMinima + 500));
  }
});
